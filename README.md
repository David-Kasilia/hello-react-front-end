...
# 📖 HELLO APP REACT <a name="about-project"></a>

> This exercise is going to have you create a React front-end with a Rails back-end API to display a random message.
...
> `git clone git@github.com:David-Kasilia/hello-react-front-end.git`
